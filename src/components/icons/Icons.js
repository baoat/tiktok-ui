//Message
export const Message = ({ className, width = '3rem', height = '3rem' }) => (
  <svg
    className={className}
    width={width}
    data-e2e=""
...
// InBox
export const Inbox = ({ className, width = '3.4rem', height = '3.4rem' }) => (
  <svg
    className={className}
    width={width}
    height={height}
...
//Upload
export const Upload = ({ className, width = '2.2rem', height = '2.2rem' }) => (
  <svg
    className={className}
    width={width}
    data-e2e=""
...
//Search
export const Search = ({ className, width = '2.6rem', height = '2.6rem' }) => (
  <svg
    className={className}
    width={width}
    height={height}
...
export const HomeIcon = ({ className, width = '3.4rem', height = '3.4rem' }) => (
  <svg
    className={className}
    width={width}
    height={height}
...
export const HomeActiveIcon = ({ className, width = '3.4rem', height = '3.4rem' }) => (
  <svg
    className={className}
    width={width}
    height={height}
...
export const UserGroupIcon = ({ className, width = '3.4rem', height = '3.4rem' }) => (
  <svg
    className={className}
    width={width}
    height={height}
...
export const UserGroupActiveIcon = ({ className, width = '3.4rem', height = '3.4rem' }) => (
  <svg
    className={className}
    width={width}
    height={height}
...
export const DiscoverIcon = ({ className, width = '3.4rem', height = '3.4rem' }) => (
  <svg
    className={className}
    width={width}
    height={height}
...
export const DiscoverActiveIcon = ({ className, width = '3.4rem', height = '3.4rem' }) => (
  <svg
    fill="currentColor"
    className={className}
    width={width}
...
export const LiveIcon = ({ className, width = '3.4rem', height = '3.4rem' }) => (
  <svg
    className={className}
    width={width}
    height={height}
...
export const LiveActiveIcon = ({ className, width = '3.4rem', height = '3.4rem' }) => (
  <svg
    className={className}
    width={width}
    height={height}
...
export const HeartActiveIconVideo = ({ className, width = '100px', height = '100px' }) => (
  <svg
    data-e2e=""
    className={className}
    width={width}
